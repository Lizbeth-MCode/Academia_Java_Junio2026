...
public class CacheExpiracion<K, V> {
    ...
    public CacheExpiracion(long defaultTtlMillis) {
    ...
    public static void main(String[] args) throws InterruptedException {
        CacheExpiracion<String, String> cache = new CacheExpiracion<>(5000);
        ...
        CacheExpiracion<Integer, String> cache2 = new CacheExpiracion<>(500);
        cache2.put(1, "uno");
        cache2.put(2, "dos");
        cache2.put(3, "tres");
